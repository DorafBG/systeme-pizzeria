...
<div class="main" bis_skin_checked="1" style="display: flex;flex-direction: row-reverse;">
<section class="recap-section">
        ...
        foreach ($lesProduits as $produit) {
            ...
            echo "<p>$nomProduit: $prixProduit €</p>";
        }
...
<form class="create-form" action="index.php" method="get">
  ...
  <label for="name">Nom du Porteur</label>
    <input class="inputNomPorteur payment-input" type="text" id="name" name="NomPorteurCB" placeholder="Asta Staria"/>
  <br>
  <label for="card">Numéro de carte</label>
    <input class="inputNumeroCarte payment-input"type="text" minlength="16" maxlength="16" id="card" name="codeCartePaiement" placeholder="0000 0000 0000 0000"/>
  <br>
  <div class="exp-cvc">
    <div class="expiration">
  <label for="expiry">Date d'expiration</label>
  <input class="inputCard payment-input" name="datePeremptionPaiement" id="expiry" type="text" minlength="5" maxlength="5" required placeholder="00/00"/>
    <br>
    </div>
    <div class="security">
  <label for="cvc">CVV</label>
    <input class="inputCVV payment-input"type="text" type="text" minlength="3" maxlength="4" id="cvc" name="cryptogrammePaiement" placeholder="XXX" />
  <br>
    </div>
  </div>
